...
```{r comment=NA, message=FALSE, include=FALSE}
...
<!--
Holding AgeGroup constant, the odds of buying a Van (vs Sedan) for Females are multiplied by `r round(OR_female_van, 3)` relative to Males.
